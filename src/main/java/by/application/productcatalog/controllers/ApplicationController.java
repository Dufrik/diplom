...
public class ApplicationController {
    ...
    public String addProduct(@ModelAttribute("product") Product product, Model model, Integer categoryId) {
        try {
